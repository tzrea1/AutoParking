"""
和per_memory.py相比，per_memory.py是配合莫烦的DDPG算法，
而sp_per_memory.py是配合spinningup系列打包的强化类写的。
目前只单独适配了TD3_per_class.py，SAC的还没有适配，sp的DDPG也没适配。
"""
...
class PriReplayBuffer(object):  # stored as ( s, a, r, s_ ) in SumTree
    ...
    # 25000
    abs_err_upper = 20000.  # clipped abs error
    ...
    def sample(self, batch_size=32):
        ...
        for i in range(n):
            ...
            terminal_batch.append(0. if data[3] else 1.)
        ...
        return b_idx, state_batch, action_batch, reward_batch, \
               next_state_batch, terminal_batch, ISWeights
